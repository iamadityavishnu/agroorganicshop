<div class="box"> <!-- box begins --> 
    ...
    <form action="" method="post" enctype="multipart/form-data"> <!-- from begins -->
        ...
        <div class="text-center"> <!-- text-center begins -->
            ...
            <button  style="margin: 10px" name="place_order" class="btn btn-primary"> <!-- btn btn-primary begins -->

                <i class="fa fa-user-md"></i> Place order directly

            </button> <!-- btn btn-primary ends -->

            <p class="text-muted">-- or --</p>

            <button  style="margin: 10px" name="wa_place_order" class="btn btn-primary"> <!-- btn btn-primary begins -->
...
if(isset($_POST['place_order'])){
...
}else if(isset($_POST['wa_place_order'])){
    $c_name = $_POST['c_name'];
    $c_email = $_POST['c_email'];
    $c_phone = $_POST['c_phone'];
    $c_address_1 = $_POST['c_address_1'];
    ...
    if($check_cart>0){
        echo "<script>window.open('guest_whatsapp_orders.php?c_id=".$customer_id."','_self')</script>";
    }
}
